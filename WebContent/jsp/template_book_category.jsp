	...
	$(document).ready(function() {
		$('.infoprint').click(function(){
			...
			$.ajax({
				...
				url : '/SEProject/jsp/template_book_detail.jsp',
				success : function(result) {
					window.location.href = "/SEProject/jsp/bookinfo.jsp";
				},
				error : function(e){
					alert("error");
				}
...
<% 
	ArrayList<Book> list = (ArrayList<Book>)session.getAttribute("detail_list");
